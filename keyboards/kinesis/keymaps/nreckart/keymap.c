...
[_QWERTY] = LAYOUT_pretty(
  ...
  INSSHFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                                          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_DEL,
...
[_NUMBERS] = LAYOUT_pretty(
  ...
  _______,KC_COLON, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN,                                                       TD_GVTL, _______, _______, _______, _______, _______,
